/**
 * Cycle Stat Widget Component
 *
 * Displays cycle-related statistics (active cycles, avg metrics, etc.)
 * Uses shadcn/ui components with lucide-react icons
 */
...
export function CycleStatWidget({
  widget,
  isEditMode,
  onConfigure,
  onDelete,
  ...
  // Get icon component
  const IconComponent =
    ICON_MAP[config.icon as keyof typeof ICON_MAP] || Activity
  ...
  const formattedValue = useMemo(() => {
    ...
    switch (config.format) {
      ...
      case 'days':
        return `${Math.round(data.value)} Tage`
